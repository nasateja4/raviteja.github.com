...
export const defaultSpotlightModels: SpotlightModelItem[] = [
  ...
  {
    id: 'stepper-cylindrical',
    title: 'Cylindrical Stepper Motor v1',
    subtitle: 'Compact Inline Robotic Rotary Joint',
    description: 'Custom cylindrical form-factor stepper motor housing engineered for internal slip-ring integration and compact robotic arm forearms.',
    url: 'https://sketchfab.com/models/bc19dc85c3f74694924033dab609fb1a/embed?autospin=1&autostart=1',
    tools: ['SolidWorks', 'Robotics Kinematics', 'Motor Sizing'],
    slug: '3d-printing-modeling',
    subProjectId: 'custom-stepper-motor',
  },
  {
    ...
    subtitle: 'High-Torque Base Joint Hybrid Stepper',
    description: 'Custom high-torque NEMA 21 stepper motor assembly engineered for high payload capacity at robotic arm base joints.',
    url: 'https://sketchfab.com/models/61e9fc0271ed49e6af784659e9026f69/embed?autospin=1&autostart=1',
    tools: ['SolidWorks', 'CAD Modeling', 'Structural Design'],
    slug: '3d-printing-modeling',
    subProjectId: 'custom-stepper-motor',
  },
  {
    id: 'peltier-ac-1',
    title: 'Mini Peltier Air Conditioner – Water Cooled System',
    subtitle: 'SolidWorks Thermoelectric Cooling Assembly',
    description: 'Compact thermoelectric refrigeration system utilizing TEC1-12706 Peltier modules with aluminum water blocks and a dual-fan radiator loop.',
    url: 'https://sketchfab.com/models/2e30b91bc1004e47ad8c26cf396457e8/embed?autospin=1&autostart=1',
    tools: ['SolidWorks', 'Thermal Simulation', 'CFD & Heat Transfer', '3D Printing'],
    slug: '3d-printing-modeling',
    subProjectId: 'peltier-air-conditioner',
  },
  {
    id: 'peltier-ac-2',
    title: 'Mini Peltier Air Conditioner – Chassis & Ducting',
    subtitle: 'Water Cooled Thermoelectric Assembly 2',
    description: 'Secondary aerodynamic shroud and water block clamping assembly with thermal barrier insulation for condensation prevention.',
    url: 'https://sketchfab.com/models/a51a965888164d48b3abd2a614bf69cb/embed?autospin=1&autostart=1',
    tools: ['SolidWorks', 'Flow Simulation', 'Duct Design', 'Prototyping'],
    slug: '3d-printing-modeling',
    subProjectId: 'peltier-air-conditioner',
  },
];
